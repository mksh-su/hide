...
testWebP(function (e) {
    ...
    $(function () {
      !(function () {
        new Swiper(".search-top-slider", {
          ...
          pagination: { el: ".swiper-pagination-slider6", clickable: !0 },
          slidesPerView: 1.5,
          ...
          breakpoints: {
            ...
            767: { slidesPerView: 1, slidesOffsetBefore: 0 },
            860: {
              slidesPerView: 1.5,
              slidesOffsetBefore: 75,
              centeredSlides: !1,
            },
            920: { slidesPerView: 1.4, slidesOffsetBefore: 75 },
            1280: { slidesPerView: 1.7, slidesOffsetBefore: 180 },
          ...
          new Swiper(".slider12", {
            ...
            pagination: { el: ".swiper-pagination-12-about", clickable: !0 },
            slidesPerView: 1,
            slideToClickedSlide: !0,
            initialSlide: 0,
            loop: !0,
  ...
  $(document).mouseup(function (e) {
    ...
    e.target != i[0] &&
      ...
      ($(".form_body").fadeOut(), $("html").removeClass("lock"));
  }),
  $(document).ready(function () {
  ...
  $(".step-btn, .step-steps li").click(function () {
    $(".step-tab-panel:last-of-type").hasClass("active")
      ? $(".step-footer").addClass("step-footer-hidden")
      : $(".step-footer").removeClass("step-footer-hidden");
  }),
  $(
    ".about_project .container .about_project_wrap .left_column .action_button"
  ...
  $(window).on("load", function () {
    ...
    if ((console.log(e), $(window).width() >= 1280)) var i = $(e).width() + 180;
    else i = $(e).width() + 75;
    $(".search-top-consultant").css("left", i);
  }),
  $(".modal-final-btn").click(function () {
    $(this).closest(".modal").addClass("modal-finished"),
      setTimeout(function () {
  ...
  $(".object-list-tags .white_bordered_btn").click(function (e) {
    e.preventDefault(),
      $(this)
        .closest(".object-list-tags")
        .toggleClass("object-list-tags-opened"),
  ...
  $(".premium-more-btn").click(function (e) {
    e.preventDefault(),
      ...
      $(this).text(function (e, i) {
        return "подробнее о сервисе" === i
          ? "скрыть информацию о сервисе"
          : "подробнее о сервисе";
      });
  }),
  $(".our-services-btn-buyer").click(function (e) {
    e.preventDefault(),
      $(".our-services-text p ").hide(),
      $(".our-services-text-buyer").show();
  }),
  $(".our-services-btn-investor").click(function (e) {
    e.preventDefault(),
      $(".our-services-text p ").hide(),
      $(".our-services-text-investor").show();
  }),
  $(".our-services-btn-developer").click(function (e) {
    e.preventDefault(),
      $(".our-services-text p ").hide(),
      $(".our-services-text-developer").show();
  }),
  $(".our-services-btn-seller").click(function (e) {
    e.preventDefault(),
      $(".our-services-text p ").hide(),
      $(".our-services-text-seller").show();
  }),
  $(".news-list-read-more, a.news-list-item-heading").click(function (e) {
    e.preventDefault(),
      $(this).closest(".news-list-item").addClass("item-full-opened"),
      $("html").addClass("item-full-opened-body");
  }),
  $(".news-list-item-close").click(function () {
    $(this).closest(".news-list-item").removeClass("item-full-opened"),
      $("html").removeClass("item-full-opened-body");
  }),
  $(document).ready(function () {
    (size_li = $(".news-list-item").length),
      (x = 3),
      $(".news-list-item:lt(" + x + ")").css("display", "flex"),
      $(".news-list-more").click(function (e) {
        e.preventDefault(),
          (x = x + 5 <= size_li ? x + 5 : size_li),
          $(".news-list-item:lt(" + x + ")").css("display", "flex"),
          x == size_li && $(".news-list-more").hide();
      });
  }),
  $("body").on("change", "input[name^='object_list_type_']", function () {
    "object_list_type_0" === $(this).prop("name")
      ? $(this).is(":checked") &&
        ($(".object-list-tags input[type='checkbox']").prop("checked", !1),
        $(this).prop("checked", !0))
      : $("input[name^='object_list_type_0']").prop("checked", !1);
  }),
  $(".action_header_variants_list").click(function (e) {
    e.preventDefault(),
      $(".action_header_variants_list").removeClass("active"),
